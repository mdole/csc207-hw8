...
class Utils {
    ...
    /**
     * A counter to keep track of the number of swaps performed when sorting
     */
     ...
     * 
     * @post the value of counter is unchanged
     * @return count, the number of swaps performed since the counter was last
     *         reset
     */
